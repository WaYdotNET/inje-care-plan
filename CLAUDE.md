...
1. `pubspec.yaml` — bump `version` (e.g. `4.8.3+12`). **IMPORTANT**: the version code (number after `+`) must be strictly greater than any previously uploaded to Google Play Store. Current highest: **25**.
